...
pub(crate) unsafe extern "cdecl" fn blit_impl(
    ...
    let dst_data =
        core::slice::from_raw_parts_mut((*dst).data, ((*dst).row_stride * (*dst).height) as usize);
    let src_data =
...
pub(crate) unsafe fn blit_stippled_raw(
    dst: *mut openwa_core::bitgrid::DisplayBitGrid,
    src: *mut openwa_core::bitgrid::DisplayBitGrid,
    dst_x: i32,
    dst_y: i32,
...
pub(crate) unsafe fn blit_tiled_raw(
    dst: *mut openwa_core::bitgrid::DisplayBitGrid,
    src: *mut openwa_core::bitgrid::DisplayBitGrid,
    initial_x: i32,
    dst_y: i32,
