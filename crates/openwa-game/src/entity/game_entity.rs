...
use super::base::{BaseEntity, Vtable};
...
// `WORLD_ENTITY_VTABLE` is generated by the `#[vtable(va = ...)]`
// attribute on `WorldEntityVtable`. `SOUND_EMITTER_VTABLE` lives in
// `super::sound_emitter`.
...
pub const CGAMETASK_SOUND_EMITTER_VT: u32 = super::sound_emitter::SOUND_EMITTER_VTABLE;
...
#[repr(C)]
pub struct WorldEntity<V: Vtable = *const WorldEntityVtable, S: SubclassData = [u8; 0x4C]> {
    ...
    pub subclass_data: S,
    /// 0x84: Position of the entity as a fixed point vector.
    /// The X coordinate is at 0x84, the Y coordinate at 0x88.
    pub pos: Vec2,
...
bind_WorldEntityVtable!(WorldEntity, base.vtable);

impl<V: Vtable, S: SubclassData> WorldEntity<V, S> {
