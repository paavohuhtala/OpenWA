...
pub mod va {
    ...
    crate::define_addresses! {
        class "DDGameWrapper" {
            ...
            /// DDGameWrapper__IsFramePaused (usercall EAX=this, no stack params,
            /// plain RET). Fully ported in `engine::dispatch_frame::is_frame_paused`;
            /// kept here for stack-trace symbolication.
            fn/Usercall DDGAMEWRAPPER_IS_FRAME_PAUSED = 0x00534880;
            /// Online sub-check of IsFramePaused (usercall ESI=this, no stack params,
            /// plain RET). Still bridged; called when `DDGame::net_session != null`.
            fn/Usercall DDGAMEWRAPPER_IS_FRAME_PAUSED_ONLINE = 0x0052DC70;
            /// Offline sub-check of IsFramePaused (usercall EDI=this, no stack params,
            /// plain RET). Still bridged.
            fn/Usercall DDGAMEWRAPPER_IS_FRAME_PAUSED_OFFLINE = 0x0052F770;
