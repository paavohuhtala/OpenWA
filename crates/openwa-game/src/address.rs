...
pub mod va {
    ...
    pub use crate::task::worm::{
        ENTITY_ACTIVITY_QUEUE_RESET_RANK, WORM_ENTITY_APPLY_DAMAGE,
        WORM_ENTITY_CANCEL_ACTIVE_WEAPON, WORM_ENTITY_COMMIT_PENDING_HEALTH,
        WORM_ENTITY_CONSTRUCTOR, WORM_ENTITY_NOTIFY_MOVED, WORM_ENTITY_SELECT_WEAPON,
        WORM_ENTITY_START_FIRING, WORM_ENTITY_VTABLE,
    };
