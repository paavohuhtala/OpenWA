...
pub mod va {
    ...
    pub use crate::entity::worm::{
        ENTITY_ACTIVITY_QUEUE_RESET_RANK, TEAM_ARENA_SET_ACTIVE_WORM,
        WEAPON_SPAWN_DECODE_DESCRIPTOR, WORM_ENTITY_APPLY_DAMAGE,
        WORM_ENTITY_BROADCAST_WEAPON_NAME, WORM_ENTITY_BROADCAST_WEAPON_SETTINGS,
        WORM_ENTITY_CAN_IDLE_SOUND, WORM_ENTITY_CANCEL_ACTIVE_WEAPON,
        WORM_ENTITY_CLEAR_WEAPON_STATE, WORM_ENTITY_COMMIT_PENDING_HEALTH, WORM_ENTITY_CONSTRUCTOR,
        WORM_ENTITY_NOTIFY_MOVED, WORM_ENTITY_SELECT_BOUNCE, WORM_ENTITY_SELECT_FUSE,
        WORM_ENTITY_SELECT_HERD, WORM_ENTITY_SELECT_WEAPON, WORM_ENTITY_START_FIRING,
        WORM_ENTITY_VTABLE, WORM_FINISH_TURN_CLEANUP,
    };
    ...
    pub use crate::render::ddraw::compat_renderer::{
        COMPAT_RENDERER_FLIP, COMPAT_RENDERER_PRESENT_WINDOWED, COMPAT_RENDERER_PRESENT_WINDOWED_B,
