...
pub unsafe fn thiscall_1(ghidra_addr: u32, this: u32, arg1: u32) {
    unsafe {
        let f: extern "fastcall" fn(u32, u32, u32) = core::mem::transmute(rb(ghidra_addr));
        f(this, 0, arg1);
    }
}
...
pub unsafe fn thiscall_1_ret(ghidra_addr: u32, this: u32, arg1: u32) -> u32 {
    unsafe {
        let f: extern "fastcall" fn(u32, u32, u32) -> u32 = core::mem::transmute(rb(ghidra_addr));
        f(this, 0, arg1)
    }
}
...
pub unsafe fn thiscall_indirect_1(vtable_slot_addr: u32, this: u32, arg1: u32) {
    unsafe {
        ...
        let f: extern "fastcall" fn(u32, u32, u32) = core::mem::transmute(fn_ptr);
        f(this, 0, arg1);
    }
}
...
pub unsafe fn stdcall_2(ghidra_addr: u32, arg1: u32, arg2: u32) {
    let f: extern "stdcall" fn(u32, u32) = unsafe { core::mem::transmute(rb(ghidra_addr)) };
    f(arg1, arg2);
}
