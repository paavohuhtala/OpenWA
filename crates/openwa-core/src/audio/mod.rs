...
pub use dssound::{is_slot_loaded, is_channel_playing, stop_channel, load_wav, noop as dssound_noop, returns_0 as dssound_returns_0, returns_1 as dssound_returns_1};
pub use music::Music;
