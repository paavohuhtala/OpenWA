...
Keyboard input
  ...
  -> Sets TurnGame+0x1F4 = 1 ("hurry requested")
  -> TurnGame ProcessInput (msg 4)
     -> TurnGame_HurryHandler (0x55E5F0)
        checks TurnGame+0x1F4
        Normal game: SendGamePacketWrapped(0x17, 0)
        Replay mode:  DDGame+0x7E41 = 1 (deferred hurry)
...
|----------|------|-------------|
| 0x462DF0 | ReplayLoader | Loads .WAgame file. Validates magic 0x4157 ("WA"), stores payload at DDGame+0xDB1C. param_2: 1=play, 2=getmap, 3=getscheme, 4=repair. |
...
| 0x55DC00 | TurnGame_HandleMessage | Message dispatcher. Case 2=FrameFinish, 4=ProcessInput. |
| 0x55E5F0 | TurnGame_HurryHandler | Hurry logic. Normal: packet 0x17. Replay: deferred flag. __usercall(ESI). |
| 0x55FDA0 | TurnManager_ProcessFrame | Per-frame turn timer, decrements by 0x14 (20ms). |
| 0x5611E0 | TurnGame_AutoSelectTeams | Iterates teams during ProcessInput, sends packet 0x2B. |
...
To bypass keyboard simulation entirely, set DDGame+0x7E41 = 1 from our DLL thread.
